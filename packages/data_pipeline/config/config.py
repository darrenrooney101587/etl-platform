...
class S3Config:
    ...
    This dataclass holds all necessary configuration parameters for S3 file processing
    operations including source and destination buckets, AWS credentials, and processing options.
    ...
    :param agency_id: Optional agency ID for fallback folder naming
    ...
    :type aws_region: str
    :param max_workers: Maximum number of worker threads for concurrent processing
